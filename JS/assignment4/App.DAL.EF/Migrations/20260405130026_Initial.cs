        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SyncDt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TodoCategories_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    PriorityName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TodoPriorities_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ListItems_ApiKeys_ApiKeyId",
                        column: x => x.ApiKeyId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskSort = table.Column<int>(type: "integer", nullable: false),
                    CreatedDt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DueDt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsCompleted = table.Column<bool>(type: "boolean", nullable: false),
                    IsArchived = table.Column<bool>(type: "boolean", nullable: false),
                    TodoCategoryId = table.Column<Guid>(type: "uuid", nullable: false),
                    TodoPriorityId = table.Column<Guid>(type: "uuid", nullable: false),
                    SyncDt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TodoTasks_TodoCategories_TodoCategoryId",
                        column: x => x.TodoCategoryId,
                        principalTable: "TodoCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TodoTasks_TodoPriorities_TodoPriorityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TodoCategories_AppUserId",
                table: "TodoCategories",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TodoPriorities_AppUserId",
                table: "TodoPriorities",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TodoTasks_TodoCategoryId",
                table: "TodoTasks",
                column: "TodoCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_TodoTasks_TodoPriorityId",
                table: "TodoTasks",
